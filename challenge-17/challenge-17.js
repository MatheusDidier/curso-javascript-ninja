(function(){
  ...
  */
  ...
  // ?
          text = text.replace(/Manuel Marques de Sousa/, "Matheus Didier Fernandes de Lima");
        console.log(text);
  /*
  ...
  */
  ...
  // ?
         text = text.replace(/brasileiro/, "paulista");
        console.log(text);
  /*
  ...
  */
  ...
  // ?
      text = text.replace(/O Centauro de Luvas/g, function(item){
  ...
  */
        ...
        function replaceComRegex(regex){
          text =  text.replace(regex, function(item, item1, item2, item3){
                return item1 + "/" + getMonthNumber(item2) + "/" + item3;
            });

        }

        replaceComRegex(regexDate);
        console.log(text);
  console.log( '\nReplace de datas:' );
  // ?
}();
