(function(){
  ...
  */
  ...
  // ?
    ...
    var matheus = new Person("Matheus", "Didier", 20);
    var elise = new Person("Elise", "Amin", 18);
  ...
  */
  ...
  // ?
    ...
    console.log(elise.getFullName() + " tem " + elise.getAge() + " anos.");
  ...
  */
  console.log( '\nNova idade das pessoas:' );
    ...
    console.log(elise.getFullName() + " agora tem " + elise.getAge() + " anos.");
